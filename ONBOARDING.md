...
5. **Meet the flagship generation** — [quilt](https://github.com/SuperInstance/quilt) (the grid IS the runtime), [plainsong](https://github.com/SuperInstance/plainsong) (text notation → MIDI), [crab-traps](https://github.com/SuperInstance/crab-traps) (every catch lays a brick in THE REEF), the [elephant](https://github.com/SuperInstance/elephant) (the room-temperature sense), [OpenConstruct](https://github.com/SuperInstance/openconstruct-kernel) (rooms whose layout IS the prompt). The [README](./README.md) tells their story.
